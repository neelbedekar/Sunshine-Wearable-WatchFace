...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    private void updateWearable(){
        ...
        intent.setAction("com.example.android.sunshine.broadcastreceiver");
        if(cursor.moveToFirst()) {
            ...
            intent.putExtra("artResourceId", artResourceId);
            intent.putExtra("artUrl", artUrl);
            intent.putExtra("largeIconHeight",largeIconHeight);
            intent.putExtra("largeIconWidth",largeIconWidth);
