...
, GoogleApiClient.OnConnectionFailedListener {
     ...
     */
    static final String PROJECT_NUMBER = "jokeproject-1052";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        IntentFilter intentFilter = new IntentFilter("com.example.android.sunshine.broadcastreceiver");
    ...
    public void onConnectionSuspended(int i) {
        Log.e(MainActivity.class.getSimpleName(),"connection suspended");
    }

    @Override
    public void onConnectionFailed(ConnectionResult connectionResult) {
        Log.e(MainActivity.class.getSimpleName(),"connection failed");
    }

    public void sendData(Bitmap bitmap, final double high, final double low){
                ...
                .setResultCallback(new ResultCallback<DataApi.DataItemResult>() {
                    ...
                    public void onResult(DataApi.DataItemResult dataItemResult) {
                        if (!dataItemResult.getStatus().isSuccess()) {
                            Log.e(MainActivity.class.getSimpleName(), "failure");
                        }
                    }
                });
    }
    ...
    public class MyReceiver extends BroadcastReceiver{
        ...
        public void onReceive(Context context, Intent intent) {
            if(client.isConnected()){
                ...
                list.add(intent.getStringExtra("artUrl"));
                list.add(Integer.toString(intent.getIntExtra("artResourceId", 1)));
                list.add(Integer.toString(intent.getIntExtra("largeIconWidth", 48)));
                list.add(Integer.toString(intent.getIntExtra("largeIconHeight", 48)));
                list.add(Double.toString(intent.getDoubleExtra("high", 1)));
                list.add(Double.toString(intent.getDoubleExtra("low", 1)));
                new FetchImage().execute(list);
            }
        }
    }

    public class FetchImage extends AsyncTask<ArrayList<String>, Void, ArrayList<String>>{
        @Override
        protected void onPostExecute(ArrayList<String> strings) {
            if(bitmap!=null) {
                sendData(bitmap, Double.parseDouble(strings.get(4)), Double.parseDouble(strings.get(5)));
            }
        }
            ...
            if(list!=null&&list.size()==6) {
                try {
                    bitmap = Glide.with(MainActivity.this)
                            .load(list.get(0))
                            .asBitmap()
                            .error(Integer.parseInt(list.get(1)))
                            .fitCenter()
                            .into( Integer.parseInt(list.get(2)), Integer.parseInt(list.get(3))).get();
                } catch (InterruptedException | ExecutionException e) {
                    Log.e(LOG_TAG, "Error retrieving large icon from " + list.get(0), e);
                    bitmap = BitmapFactory.decodeResource(MainActivity.this.getResources(), Integer.parseInt(list.get(1)));
                }
            }
            return list;
        }
